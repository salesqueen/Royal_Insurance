...
<title>Manage Branch Manager</title>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item active" href="menu_manage_user_branch_manager.php">Branch Manager</a>
  ...
  <section id="main-container">
    <div class="container">
      <div class="table-container">
        <div class="row">
          <div class="col-md-12">
              <h2>Manage Branch Manager</h2> 

              <ul class="nav nav-tabs">
                  <li><a data-toggle="tab" href="#branch-manager" class="active">Manage Branch Manager</a></li>
              </ul>
