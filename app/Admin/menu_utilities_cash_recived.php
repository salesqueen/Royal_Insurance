<?php 
    ...
    if($GLOBALS['constraint']==""){
        $transaction_result_set=$GLOBALS['user']->read_selective_transaction("WHERE payment='Recived'");
    }else{
        $transaction_result_set=$GLOBALS['user']->read_selective_transaction("WHERE payment='Recived' ".$GLOBALS['constraint']);
    }
    ...
    if(isset($_POST['download_excel'])){
        ...
        header("Location:menu_utilities_cash_recived.php");
    }
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#cash_recived" class='active'>Cash Recived</a></li>
                </ul>

                <div class="tab-content"> 
                    <div id="cash_recived" class="tab-pane fade show active">
                        <!--Filter-->
                        <div class="row filter">
                            ...
                            <div class="col-md-4">
                                <a href="create_transaction.php?transaction_type=Recived" style="float:right"><button>New Transaction</button></a>
                            </div>
                        </div>
