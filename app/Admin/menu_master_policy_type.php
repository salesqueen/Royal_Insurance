                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="menu_master_policy_type.php">Policy Type</a>
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#policy_type" class="active">Policy Type</a></li>
                </ul>

                <div class="tab-content"> 
                    <div id="policy_type" class="tab-pane fade active show">
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <br>
                                    <input type="submit" value="Create" name="policy_type_form_submit" class="btn btn-primary">
                                </div>
                            </div>
                        </form>
