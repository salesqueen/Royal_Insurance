<?php
  ...
  //fetching main
  $result_set=$user->read_one_company($_GET['id']);
  $result=$result_set->fetch_assoc();

  //form handelling
  if(isset($_POST['submit'])){
      $name_array=Company_Contract::get_table_columns();
      $user->update_company($name_array,$_GET['id']); 
          ...
          <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="menu_master_company.php" style="float:right"><Button>Back <i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                    </div>
                </div>
                
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#agent" class="active">Edit Company</a></li>
                </ul>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'].'?id='.$_GET['id']; ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" value="<?php echo $result['company_name'];?>" class="form-control" id="company_name" name="company_name" placeholder="Company Name" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
