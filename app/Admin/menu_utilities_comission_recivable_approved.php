<?php 
    ...
    if(isset($_POST['download_excel'])){
        ...
        $download->comission_recivable_approved($approved_policy_result_set);
    }
...
<head>
  ...
  <title>Comission Recivable Approved</title>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="menu_utilities_comission_recivable_approved.php">Comission Recivable Approved</a>
        ...
        <div class="form-container">
          <div class="row">
            <div class="col-md-12">
                ...
                <!--Heading-->
                    <div class="col-md-6">
                        <h2>Comission Recivable Approved</h2>
                    </div>
                    <div class="col-md-6">
                ...
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#comission-recivable" class="active">Comission Recivable Approved</a></li>
                </ul>
