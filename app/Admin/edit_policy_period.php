<?php
  ...
  //fetching main
  $result_set=$user->read_one_policy_period($_GET['id']);
  $result=$result_set->fetch_assoc();

  //form handelling
  if(isset($_POST['submit'])){
      $name_array=Policy_Period_Contract::get_table_columns();
      $user->update_policy_period($name_array,$_GET['id']); 
      header('Location:menu_master_policy_period.php');
  }
...
<head>
  ...
  <title>Edit Policy Period</title>
        ...
        <div class="form-container">
          <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h2>Edit Policy Period</h2>
                    </div>
                    <div class="col-md-6">
                        <a href="menu_master_policy_period.php" style="float:right"><Button>Back <i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                    </div>
                </div>
                
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#agent" class="active">policy Period</a></li>
                </ul>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'].'?id='.$_GET['id']; ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" value="<?php echo $result['policy_period']?>" class="form-control" id="policy_period" name="policy_period" placeholder="Policy Period" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
