<?php
  ...
  //fetching main
  $result_set=$user->read_one_product($_GET['id']);
  $result=$result_set->fetch_assoc();

  //form handelling
  if(isset($_POST['submit'])){
      $name_array=Product_Contract::get_table_columns();
      $user->update_product($name_array,$_GET['id']); 
          ...
          <div class="row">
            <div class="col-md-12"> 
                ...
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#agent" class="active">Edit Product</a></li>
                </ul>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'].'?id='.$_GET['id']; ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" value="<?php echo $result['product'];?>" class="form-control" id="product" name="product" placeholder="Product" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
