<?php 
    ...
    //form handelling
    if(isset($_POST['company_code_form_submit'])){
        $user->insert_company_code();
                ...
                <div id="company" class="tab-pane fade active show">
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <br>
                                <input type="submit" value="Create" name="company_code_form_submit" class="btn btn-primary">
                            </div>
                        </div>
                    </form>
                                ...
                                <?php
                                    if($company_code_result_set){
                                        while($company_code_result=$company_code_result_set->fetch_assoc()){
                                            echo "<tr>";
                                            echo "  <td>".$company_code_result['company_name']."</td>";
                                            echo "  <td>".$company_code_result['company_code']."</td>";
                                            echo "  <td>".$company_code_result['remark']."</td>";
                                            echo '  <td>
                                                        <a href="edit_company_code.php?id='.$company_code_result['id'].'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                        <a href="delete_company_code.php?id='.$company_code_result['id'].'"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>
                                                    </td>';
                                            echo "</tr>";
                                        }
                                    }
