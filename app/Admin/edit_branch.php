<?php 
  ...
  $branch_result_set=$user->read_one_branch($_GET['id']);
  $branch_result=$branch_result_set->fetch_assoc();

  //form handelling
  if(isset($_POST['submit'])){
      $user->update_branch(Branch_Contract::get_table_columns(),$_GET['id']);
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="menu_manage_user_create_branch.php" style="float:right"><Button>Back <i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                    </div>
                </div>

                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#create_branch" class="active">Edit Branch</a></li>
                </ul>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'].'?id='.$_GET['id'] ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="branch" name="branch" placeholder="Branch" required="required" value="<?php echo $branch_result['branch'];?>">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                    <label for="remark">Remark</label>
                                    <input type="text" class="form-control" id="remark" name="remark" placeholder="Remark" required="required" value="<?php echo $branch_result['remark'];?>">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                    <br>
