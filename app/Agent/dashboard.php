          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#insert_policy" class="active">Create Policy</a></li>
                </ul>

                <div class="tab-content">
                    <div id="insert_policy" class="tab-pane fade show in active">
                        <h4>Create Policy</h4>
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="policy_number" name="policy_number" placeholder="Policy Number" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="mobile" name="mobile" placeholder="Mobile" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="od_policy_start_date" name="od_policy_start_date" placeholder="OD Policy Start Date" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="od_policy_end_date" name="od_policy_end_date" placeholder="OD Policy End Date" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                    <label for="tp_policy_start_date">TP Policy Start Date</label>
                                    <input type="date" class="form-control" id="tp_policy_start_date" name="tp_policy_start_date" placeholder="TP Policy Start Date" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="tp_policy_end_date" name="tp_policy_end_date" placeholder="TP Policy End Date" required="required">
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <br>
                                    <label>OD Premium<input type="radio" id="comission_type" value="OD" name="comission_type" checked></label>
                                    <label>NET Premium<input type="radio" id="comission_type" value="NP" name="comission_type"></label>
                                </div>
                                <!--Col-->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 policy_cheque_data">
                                    ...
                                    <input type="text" class="form-control" id="cheque_number" name="cheque_number" placeholder="Cheque Number">
                                </div>
                                <!--Col-->
                                <div class="col-md-4 policy_cheque_data">
