                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-4 card">
                            <h2><i class="fa fa-file-powerpoint-o" aria-hidden="true"></i> <?php echo $user->get_agent_policy_count($_SESSION['id']);?></h2>
                            <h1 class="fa fa-line-chart" aria-hidden="true"></h1>
                            <p>Policies</p>
                        </div>
                        <div class="col-md-4 card">
                            <h2><span class="fa fa-inr"></span>.<?php echo $user->get_agent_cash("Recived",$_SESSION['id']);?></h2>
                            <h1 class="fa fa-plus-square-o" aria-hidden="true"></h1>
                            <p>Cash Recived</p>
                        </div>
                        <div class="col-md-4 card">
                            <h2><span class="fa fa-inr"></span>.<?php echo $user->get_agent_cash("Paid",$_SESSION['id']);?></h2>
                    ...
                    <div class="row">
                        <div class="col-md-12 wallet">
                            ...
                            <h2><span class="fa fa-inr"></span>.<?php echo (-1)*$user->get_wallet_amount($_SESSION['id']);?></h2>
                        </div>
                    </div>
                </div>
                <!--Calendar-->
