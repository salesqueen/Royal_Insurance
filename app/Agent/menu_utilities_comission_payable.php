<?php 
    ...
    if($constraint==""){
        $pending_policy_result_set=$user->read_selective_policy('WHERE ((comission_percentage=0 AND payment_mode="Cash") OR (comission_percentage=0 AND payment_mode="Online")) AND (agent_id='.$_SESSION['id'].')');
    }else{
        $pending_policy_result_set=$user->read_selective_policy('WHERE ((comission_percentage=0 AND payment_mode="Cash") OR (comission_percentage=0 AND payment_mode="Online")) AND (agent_id='.$_SESSION['id'].') '.$constraint);
    }
    //pending policy via cheque
    $cleared_cheque_pending_policy_array=$user->get_cleared_cheque_pending_policy_agent("comission_percentage",$_POST['company_name'],$_POST['company_code'],$_POST['filter_start_date'],$_POST['filter_end_date'],$_SESSION['id']);
    //getting approved policy
    if($constraint==""){
        $approved_policy_result_set=$user->read_selective_policy('WHERE NOT comission_percentage=0 AND agent_id='.$_SESSION['id']);
    }else{
        $approved_policy_result_set=$user->read_selective_policy('WHERE NOT (comission_percentage=0) AND (agent_id='.$_SESSION['id'].') '.$constraint);
    }
    //company
    ...
    if(isset($_POST['download_excel'])){
        ...
        $download->comission_payable($pending_policy_result_set,$cleared_cheque_pending_policy_array,$approved_policy_result_set);
    }
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item active" href="menu_utilities_comission_payable.php">Comission</a>
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#comission-payable" class="active">Comission</a></li>
                </ul>

                <div class="tab-content"> 
                    
                    <div id="comission-payable" class="tab-pane fade show active">
                        <!--Filter-->
                                    ...
                                    <?php
                                        ...
                                        if($approved_policy_result_set){
                                            while($approved_policy_result=$approved_policy_result_set->fetch_assoc()){
                                                ...
                                                echo "  <td>".$approved_policy_result['comission_type']."</td>";
                                                echo "  <td>".$comission."</td>";
                                                echo "  <td>".$user->get_agent_name($approved_policy_result['agent_id'])."</td>"; 
                                                echo "  <td>Approved</td>";
                                                echo '  <td><a href="view_policy.php?id='.$approved_policy_result['id'].'"><i class="fa fa-eye" aria-hidden="true"></i></a></td>';
                                                echo "</tr>";
                                            }
                                        }
                                    ?>
        ...
        <div class="container">
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <label for="ajax_company_code">Booking Code</label>
