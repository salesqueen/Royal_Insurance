<?php 
    ...
    if($GLOBALS['constraint']==""){
        $transaction_result_set=$GLOBALS['user']->read_selective_transaction("WHERE payment='Paid' AND agent_id=".$_SESSION['id']);
    }else{
        $transaction_result_set=$GLOBALS['user']->read_selective_transaction("WHERE payment='Paid' AND agent_id=".$_SESSION['id']." ".$GLOBALS['constraint']);
    }
