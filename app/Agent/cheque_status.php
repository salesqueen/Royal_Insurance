<?php 
  ...
  function get_pending_cheque(){
    $pending_cheque_result_set=$GLOBALS['admin']->read_selective_cheque("WHERE cheque_status='Pending' LIMIT 10");
    return $pending_cheque_result_set;
  }
  //fetching cleared cheques
  function get_cleared_cheque(){
    $cleared_cheque_result_set=$GLOBALS['admin']->read_selective_cheque("WHERE NOT cheque_status='Pending' LIMIT 10");
  ...
  if(isset($_POST['clear_submit'])){
    $GLOBALS['admin']->update_cheque($_POST['cheque_id']);
  }
...
<body>
                ...
                <div class="tab-content">
                    <div id="pending" class="tab-pane fade show in active">
                        ...
                        <div class="row filter">
                            <div class="col-sm-6">
                                <div class="search-container">
                                    <form>
                                        <input type="text" id="cheque_status_search_1" placeholder="Search" name="search">
                                    </form>
                                </div>
                            </div>   
                        ...
                        <div class="table-scroll">
                            <table id="cheque_status_table_1" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>Policy Date</th>
                                        <th>Company Name</th>
                        ...
                        <?php 
                            ...
                            $count=1;
                            $count_result_set=$admin->read_custom($sql);
                            if($count_result_set){
                    ...
                    <div id="cleared" class="tab-pane fade">
                        ...
                        <div class="row filter">
                            <div class="col-sm-6">
                                <div class="search-container">
                                    <form>
                                        <input type="text" id="cheque_status_search_2" placeholder="Search" name="search">
                                    </form>
                                </div>
                            </div>   
                        ...
                        <div class="table-scroll">
                            <table id="cheque_status_table_2" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>Policy Date</th>
                                        <th>Company Name</th>
  ...
  <!--Custom javascript-->
  <script>
        //CHEQUE STATUS SEARCH
        //search for table 1
        $(document).ready(function(){
            $("#cheque_status_search_1").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#cheque_status_table_1 tr").filter(function() {
        ...
        //table for table 2
        $(document).ready(function(){
            $("#cheque_status_search_2").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#cheque_status_table_2 tr").filter(function() {
                $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });
        });
