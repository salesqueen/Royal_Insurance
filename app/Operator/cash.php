<?php 
  ...
  function get_cash_recived_result_set(){
    $cash_recived_result_set=$GLOBALS['admin']->read_selective_cash("WHERE NOT amount=0 AND type='Recivable'");
    return $cash_recived_result_set;
  }
  //fetching paid cash data
  function get_cash_paid_result_set(){
    $cash_paid_result_set=$GLOBALS['admin']->read_selective_cash("WHERE NOT amount=0 AND type='Payable'");
