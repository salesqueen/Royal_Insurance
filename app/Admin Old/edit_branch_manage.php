<?php
  ...
  if(isset($_POST['submit'])){
      ...
      $user->update_branch_manager($name_array,$_GET['id']); 
  }
          ...
          <div class="row">
            <div class="col-md-12"> 
                ...
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#branch_manager" class="active">Branch Manager</a></li>
                </ul>

                <div class="tab-content">
                    <div id="branch_manager" class="tab-pane fade show in active">
