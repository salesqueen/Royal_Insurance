                ...
                <div class="row">
                    <?php 
                        if($policy_files_result){
                            ?>
                    <div class="col-md-12">
                        <embed style="width:100%;height:600px" src="../Php/Util/uploads/policy_documents/<?php echo $policy_files_result['file_1']?>" type="application/pdf">
                    </div>
                    <div class="col-md-12">
                        <embed style="width:100%;height:600px" src="../Php/Util/uploads/policy_documents/<?php echo $policy_files_result['file_2']?>" type="application/pdf">
                    </div>
                    <div class="col-md-12">
                        <embed style="width:100%;height:600px" src="../Php/Util/uploads/policy_documents/<?php echo $policy_files_result['file_3']?>" type="application/pdf">
                    </div>
                    <div class="col-md-12">
                        <embed style="width:100%;height:600px" src="../Php/Util/uploads/policy_documents/<?php echo $policy_files_result['file_4']?>" type="application/pdf">
                    </div>
                    <?php
                        }else{
                            echo "No documents";
