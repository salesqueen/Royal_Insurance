                  ...
                  <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="menu_manage_user_operator.php">Operator</a>
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <ul class="nav nav-tabs">
                  <li><a data-toggle="tab" href="#operator" class="active">Manage Operator</a></li>
              </ul>

              <div class="tab-content">
                  <div id="operator" class="tab-pane fade active show">
